...
class Address extends ApiModel
{
	...
	/**
     * Вызвать метод getWarehouseTypes() - загрузить справочник типов отделений компании «Новая Почта»
     *
     * @param MethodParameters $data
     * @return \NovaPoshta\Models\DataContainerResponse
     */
    ...
    /**
     * Вызвать метод searchSettlements() - онлайн-поиск населенных пунктов
     *
     * @param MethodParameters $data
     * @return \NovaPoshta\Models\DataContainerResponse
     */
    public static function searchSettlements(MethodParameters $data = null)
    {
        return self::sendData(__FUNCTION__, $data);
    }
	
    /**
     * Вызвать метод searchSettlementStreets() - онлайн-поиск улиц
     *
     * @param MethodParameters $data
     * @return \NovaPoshta\Models\DataContainerResponse
     */
    public static function searchSettlementStreets(MethodParameters $data = null)
    {
        return self::sendData(__FUNCTION__, $data);
    }
